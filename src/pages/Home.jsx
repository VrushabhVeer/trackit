        ...
        {jobs.length === 0 ? (
          <div className="w-full text-center py-16 border border-dashed border-gray-300 rounded-md bg-white">
            <div className="flex flex-col items-center justify-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-700 mt-4">No job applications found</h3>
              <p className="text-gray-500">You haven&lsquo;t added any job applications yet.</p>
              <button
                onClick={openModal}
